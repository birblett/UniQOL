...
ENABLE_FREE_NATURE_CHANGE = true
...
def uniqol_asset_relative(path) = "UniQOL/UniQOLAssets/#{path}"

def uniqol_asset(path) = UniLib.path "UniQOL/UniQOLAssets/#{path}"
...
if ENABLE_PREEVO_RELEARN_OPTION and Rejuv
...
if ENABLE_FREE_NATURE_CHANGE and Reborn
